...
export function ComingSoon() {
  return (
    <section className='h-[740px]'>
      <LampContainer className='!pt-2 !min-h-full'>
        <motion.h1
        ...
        >
          <div className='relative flex flex-col md:flex-row '>
            <div className='text-3xl md:text-6xl font-bold absolute text-foreground md:left-[200px]  md:bottom-[110px] md:w-[480px] bottom-[315px] left-[80px] drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]'>
              COMING SOON
            </div>
