        ...
        >
          ...
          <Card>
            <div className="relative h-60 w-full">
              <Image
                src={item.image} // Projeden resim URL'sini alır
                alt={item.title}
                layout="fill"
                objectFit="cover"
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-neutral-200 dark:bg-black border border-transparent dark:border-white/[0.2] group-hover:border-slate-700 relative z-20",
        className
      )}
    >
