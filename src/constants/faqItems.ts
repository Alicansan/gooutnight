export const faqItems = [
  ...
  },
  {
    value: "item-4",
    question:
      "Is there a way to filter venues by music genre or DJ performing?",
    answer:
      "Absolutely! Our advanced search feature allows you to filter venues not only by location and time but also by music genre and scheduled DJ or artist performances.",
  },
  {
    value: "item-5",
  ...
  {
    value: "item-6",
    question: "Who can I contact for business inquiries or partnerships?",
    answer:
      "For business inquiries or partnerships, please reach out to our In-House General Counsel, Sarah Gulati, who handles our business contracts and partnerships. You can find her contact information on our 'Contact Us' page.",
  },
];
